...
{
    public partial class GroupsClients : Form
    {

        private OleDbConnection mycon;
        int sh;
        public static string grcl;
        ...
        private void GroupsClients_Load(object sender, EventArgs e)
        {
        ...
        {
            OleDbCommand cmd1 = new OleDbCommand("SELECT COUNT(*) FROM GrupuriClienti WHERE denumire = '" + textBox2.Text + "' ");
            mycon.Open();
            ...
            if (denumireCount < 1)
            {
                ...
                cmd.CommandText = "INSERT INTO GrupuriClienti (denumire) VALUES ('" + textBox2.Text + "')";
        ...
        private void toolStripButton2_Click(object sender, EventArgs e)
        {
            ...
            if (count != 0)
            {
                OleDbCommand cmd1 = new OleDbCommand("DELETE FROM GrupuriClienti WHERE id = " + dataGridView1.SelectedRows[0].Cells[1].Value.ToString() + "");
                cmd1.Connection = mycon;
                mycon.Open();
                cmd1.ExecuteNonQuery();
                grupuriClientiTableAdapter.Update(_CNLR_2015_2016DataSet.GrupuriClienti);
                mycon.Close();
                this.grupuriClientiTableAdapter.Fill(this._CNLR_2015_2016DataSet.GrupuriClienti);
                if (sh == 1)
        ...
        private void toolStripTextBox1_KeyPress(object sender, KeyPressEventArgs e)
        {
            if (e.KeyChar == (char)Keys.Enter)
            {
                ...
                OleDbCommand cmd = new OleDbCommand();
                cmd.CommandType = CommandType.Text;
                cmd.CommandText = @"SELECT * FROM GrupuriClienti WHERE (denumire) LIKE ('%" + toolStripTextBox1.Text + "%')";
                mycon.Open();
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            if (count == 0)
            {
                grcl = dataGridView1.SelectedCells[0].Value.ToString();
            }
            else
